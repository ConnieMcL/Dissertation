...
tweetdate= datetime.date(2017,4,19)
...
def main():
    ...
    tweetdate= datetime.date(2017,8,17)
...
#for i in range(1,1638):
    for i in range(1,1638):
        ...
        query_params = {'query': '$ETH ETHEREUM Ethereum -RT',
    ...
    endDF.to_csv(r'C:\Users\conni\Documents\eth_tweet_data.csv',index=False)
